            ...
            >
              <div className="p-4 space-y-4">
                ...
                <div>
                  ...
                  <Slider
                    value={filters.roi}
                    onValueChange={(value) => setFilters(prev => ({ ...prev, roi: value as [number, number] }))}
                    max={50}
                    min={0}
                    step={1}
                    className="w-full"
                ...
                <div>
                  ...
                  <Slider
                    value={filters.score}
                    onValueChange={(value) => setFilters(prev => ({ ...prev, score: value as [number, number] }))}
                    max={100}
                    min={0}
                    step={5}
                    className="w-full"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Slider
                      ...
                      onValueChange={(value) => setFilters(prev => ({ ...prev, squareFootage: value as [number, number] }))}
                      max={10000}
                      min={100}
                      step={100}
                      className="w-full"
