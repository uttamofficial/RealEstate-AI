      ...
      <div className={`container mx-auto px-4 sm:px-6 lg:px-8 py-8 transition-all duration-500 ${
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
            <Card className="bg-black/40 dark:bg-slate-900/40 border-0 shadow-2xl backdrop-blur-2xl border-cyan-500/20 dark:border-cyan-700/20 rounded-2xl hover:shadow-cyan-500/25 transition-all duration-300 group">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-slate-400 dark:text-slate-400">Total Properties</p>
                    <p className="text-3xl font-bold text-cyan-400 dark:text-cyan-300">18</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-blue-400 dark:text-blue-300">24.7%</p>
                  </div>
                ...
                <div className="flex items-center mt-3">
                  <span className="text-lg font-semibold text-green-400">+8.3%</span>
            ...
            <Card className="bg-black/40 dark:bg-slate-900/40 border-0 shadow-2xl backdrop-blur-2xl border-purple-500/20 dark:border-purple-700/20 rounded-2xl hover:shadow-purple-500/25 transition-all duration-300 group">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-slate-400 dark:text-slate-400">Occupancy Rate</p>
                    <p className="text-3xl font-bold text-purple-400 dark:text-purple-300">89%</p>
              </div>
                ...
                <div className="flex items-center mt-3">
                  <span className="text-lg font-semibold text-green-400">+5.1%</span>
                  <span className="text-sm text-slate-400 dark:text-slate-400 ml-2">from last month</span>
            </div>
                <Progress value={89} className="mt-3 h-2 bg-slate-700" />
              </CardContent>
            </Card>
            ...
            <Card className="bg-black/40 dark:bg-slate-900/40 border-0 shadow-2xl backdrop-blur-2xl border-orange-500/20 dark:border-orange-700/20 rounded-2xl hover:shadow-orange-500/25 transition-all duration-300 group">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-slate-400 dark:text-slate-400">Market Score</p>
                    <p className="text-3xl font-bold text-orange-400 dark:text-orange-300">90/100</p>
              </div>
                ...
                <div className="flex items-center mt-3">
                  ...
                  <span className="text-sm text-slate-400 dark:text-slate-400 ml-2">from last quarter</span>
                </div>
                <Progress value={90} className="mt-3 h-2 bg-slate-700" />
              </CardContent>
            </Card>
        </div>
          ...
          <Tabs value={selectedView} onValueChange={setSelectedView} className="w-full mb-8 mt-8">
            <TabsList className="grid w-full grid-cols-4 bg-black/40 dark:bg-slate-900/40 backdrop-blur-xl border border-cyan-500/20 dark:border-fuchsia-700/20 rounded-2xl p-1">
              <TabsTrigger value="grid" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-cyan-500/20 data-[state=active]:to-blue-500/20 text-cyan-300">
                🏠 Grid View
              </TabsTrigger>
              <TabsTrigger value="analytics" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500/20 data-[state=active]:to-purple-500/20 text-blue-300">
                📊 Analytics
              </TabsTrigger>
              <TabsTrigger value="map" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500/20 data-[state=active]:to-pink-500/20 text-purple-300">
                🗺️ Map View
              </TabsTrigger>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                <Card className="bg-black/40 dark:bg-slate-900/40 border-0 shadow-2xl backdrop-blur-2xl border-blue-500/20 dark:border-blue-700/20 rounded-2xl">
                  <CardHeader>
                    ...
                    <CardDescription className="text-slate-400">Monthly value changes and ROI trends</CardDescription>
                  </CardHeader>
                  <CardContent>
